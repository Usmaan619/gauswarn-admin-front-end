...
// // import { getData, postData, deleteData } from "../../Common/APIs/api";
// // import { toastSuccess, toastError } from "../../../Services/toast.service";

// // // Insta embed component
...
// //     if (!reelId) return toastError("Reel ID required");

// //     // edit mode
// //     if (editItem) {
// //       const res = await postData(`/reels/${editItem}`, { reel_id: reelId });
// //       if (res.success) {
...
// //         return loadReels();
// //       }
// //       return toastError("Failed");
// //     }

// //     // add new
// //     const res = await postData("/reels", { reel_id: reelId });
// //     console.log('res: ', res);
// //     if (res.success) {
// //       toastSuccess("Added");
// //       setReelId("");
...
// //     const res = await deleteData(`reels/${id}`);
// //     if (res.success) {
...
// //           <p>Add only reel ID (Example: DRluM3xAU0L)</p>
...
//   // add / update
//   const saveReel = async () => {
//     const pureId = extractReelId(reelId);
//     if (!pureId) return toastError("Valid Reel ID required");

//     // edit mode
//     if (editItem) {
//       const res = await postData(`/reels/${editItem}`, { reel_id: pureId });
//       if (res.success) {
//         toastSuccess("Updated");
//         setReelId("");
//         setEditItem(null);
...
//     // add new
//     const res = await postData("/reels", { reel_id: pureId });
//     if (res.success) {
//       toastSuccess("Added");
//       setReelId("");
//       loadReels();
...
//         <div className="col-12 col-lg-10 p-4">
//           <h2>Instagram Reels</h2>
//           <p>Paste Instagram reel link OR reel ID</p>
