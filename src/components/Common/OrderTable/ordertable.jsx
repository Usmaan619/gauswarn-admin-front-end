...
const OrderTable = ({ ordersData = [], headings = [], refresh = () => {} }) => {
  ...
  return (
    <div className="recent-table d-flex flex-column w-100">
      <div className="p-3 recent-tble-header glass-card mb-3">
        <h3 className="glow-text m-0">Orders History</h3>
      </div>

      {/* FILTERS */}
      <div className="d-flex gap-2 px-3 py-2 flex-wrap mb-3">
        {/* Payment Filter */}
        <select
          className="form-select w-auto glass-card text-white border-0"
        ...
        >
          <option value="" className="bg-dark">All Payments</option>
          <option value="paid" className="bg-dark">Paid</option>
          <option value="unpaid" className="bg-dark">Unpaid</option>
        </select>

        {/* Search */}
        <input
          type="text"
          className="form-control w-auto glass-card text-white border-0"
          style={{ background: 'rgba(255,255,255,0.05)' }}
      ...
      <div className="table-responsive px-2">
        <table className="modern-table text-nowrap">
