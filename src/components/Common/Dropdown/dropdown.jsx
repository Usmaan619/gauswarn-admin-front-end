...
function FilterDropdown() {
  ...
  const monthsByYear = {
    ...
    2025: [...Array(12)].map((_, i) => ({
      label: new Date(2025, i).toLocaleString("default", {
        month: "short",
        year: "numeric",
      }),
    ...
    2026: [...Array(12)].map((_, i) => ({
      label: new Date(2026, i).toLocaleString("default", {
        month: "short",
        year: "numeric",
      }),
      value: i + 1,
    ...
    2027: [...Array(12)].map((_, i) => ({
      label: new Date(2027, i).toLocaleString("default", {
        month: "short",
        year: "numeric",
      }),
      value: i + 1,
    ...
    2028: [...Array(12)].map((_, i) => ({
      label: new Date(2028, i).toLocaleString("default", {
        month: "short",
        year: "numeric",
      }),
      value: i + 1,
    ...
    2029: [...Array(12)].map((_, i) => ({
      label: new Date(2029, i).toLocaleString("default", {
        month: "short",
        year: "numeric",
      }),
      value: i + 1,
    ...
    2030: [...Array(12)].map((_, i) => ({
      label: new Date(2030, i).toLocaleString("default", {
        month: "short",
        year: "numeric",
      }),
      value: i + 1,
